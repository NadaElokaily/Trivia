...
def create_app(test_config=None):
  ...
  def questions():
    ...
    try:
      ...
      current_categories_dict = [categories_dict[question['category']] for question in questions_dict[start:end]]
  ...
  def questions_for_each_category(category_id):
      ...
      if (category is None):
          abort(422)
      matched_questions = Question.query.filter(Question.category==category_id).all()
